...
app = Flask(__name__)
app.secret_key = 'pulseguard-secret-key-2024'
...
color_map = {
    0: '#10B981',   # Medical green
    1: '#F59E0B',   # Medical amber
    2: '#F97316',   # Medical orange
    3: '#EF4444'    # Medical red
}
...
def predict():
    try:
        if request.method == 'POST':
            ...
            # Manual scaling of ordinal features (index positions: Age=1, Severity=5, Whendiagnoused=9, Systolic=10, Diastolic=11)
            ...
            result_icon = icon_map[prediction]
